#pragma once
    ...
    #define MUSTACHE_PROFILER_BLOCK(name, ...) EASY_BLOCK(name, __VA_ARGS__)
...
#else
    #define MUSTACHE_PROFILER_BLOCK(name, ...)
    ...
    #define MUSTACHE_PROFILER_BLOCK_LVL_0(name, ...) MUSTACHE_PROFILER_BLOCK(name, __VA_ARGS__)
#else
    #define MUSTACHE_PROFILER_BLOCK_LVL_0(name, ...)
#endif

#if MUSTACHE_PROFILER_LVL >= 1
    //
    #define MUSTACHE_PROFILER_BLOCK_LVL_1(name, ...) MUSTACHE_PROFILER_BLOCK(name, __VA_ARGS__)
#else
    #define MUSTACHE_PROFILER_BLOCK_LVL_1(name, ...)
#endif

#if MUSTACHE_PROFILER_LVL >= 2
    //
    #define MUSTACHE_PROFILER_BLOCK_LVL_2(name, ...) MUSTACHE_PROFILER_BLOCK(name, __VA_ARGS__)
#else
    #define MUSTACHE_PROFILER_BLOCK_LVL_2(name, ...)
#endif

#if MUSTACHE_PROFILER_LVL >= 3
    // verbose mode
    #define MUSTACHE_PROFILER_BLOCK_LVL_3(name, ...) MUSTACHE_PROFILER_BLOCK(name, __VA_ARGS__)
#else
    #define MUSTACHE_PROFILER_BLOCK_LVL_3(name, ...)
#endif
